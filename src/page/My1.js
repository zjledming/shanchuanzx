...
export default class My extends Component {
    ...
    componentWillMount() {
        // this._navListener = this.props.navigator.navigationContext.addListener('willFocus', this._setStatusBar);
        this._navListener0 = this.props.navigator.navigationContext.addListener('willFocus',()=>Alert.alert(
            'AlertTitle',
            `页面将要获得焦点`
            ));
        this._navListener = this.props.navigator.navigationContext.addListener('didfocus',()=>Alert.alert(
            'AlertTitle',
            `页面已经获得焦点`
            ));
                ...
                <View style={styles.personalInfo}>
                    ...
                    <Image
                        ...
                        <Image
                            ...
                            // source={{uri: 'https://tvax4.sinaimg.cn/crop.0.0.480.480.180/768c39d5ly8fjje1d0teej20dc0dcq35.jpg'}}
                            source={require('../img/loginbj.png')}
                            resizeMode='stretch'
                        />
                    </View>
