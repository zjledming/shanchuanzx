...
//  新闻组件
export default class KehuPage extends Component {
            ...
            <View style={styles.wutuv}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ flex: 1 }}>
                        ...
                        <TouchableOpacity onPress={() => this.linking(rowData.phone)}>
                ...
                <View style={styles.rowldv}>
                    ...
                    <TouchableOpacity onPress={this.xgkehu.bind(this, rowData.id)}>
                        <View style={styles.rowendv}>
                            ...
                            <Text style={styles.fontheis16} ><Icons style={styles.icon14} name='user-following' color="#ffbe10" />  修改</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={this.gokehudetail.bind(this, rowData)}>
                        <View style={styles.rowendv}>
