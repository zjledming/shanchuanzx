...
import { selectKehuList, deleteKehu } from '../api/news';
...
//  新闻组件
export default class KehuxzPage extends Component {
    ...
    //         headerTintColor: '#fff',
    //         headerTitle: (
    //             <Text style={{ flex: 1, textAlign: 'center', fontSize: px2dp(16), color: '#fff',justifyContent:'center',alignItems:'center' }}>选择客户</Text>
    //         ),
    //     })
    // }
    ...
    fetchNewsData(start, end) {
        ...
        const res = selectKehuList(user_.username, this.state.text, start, end); // api接口
        res.then((newsArr) => {
    ...
    sckehu(id) {
        ...
        Alert.alert('客户删除之后无法找回，请谨慎操作，确定删除吗？', '', [
            {
                text: '取消', onPress: () => {
        ...
        return (
            <View style={styles.wutuv}>
                ...
                <View style={styles.wutuvt}>
                    <Text style={styles.wutuvttitle} >{rowData.qymc}  </Text>
                </View>

                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ flex: 1 }}>
                        <Text style={styles.wutuvcontent} ><Icons style={styles.icon14} name='user' color="#888" />  姓名：{rowData.realname}</Text>
                        {/* <TouchableOpacity onPress={() => this.linking(rowData.phone)}> </TouchableOpacity> */}
                            <Text style={styles.wutuvcontent} ><Icons style={styles.icon14} name='phone' color="#888" />  电话：{rowData.phone}</Text>
                       
                    </View>
                    <TouchableOpacity onPress={this.xzkehu.bind(this, rowData)} >
                        <View style={{ width: WIDTH03, alignItems: 'flex-end', justifyContent: 'flex-end' }}>
                            <Text style={{color:'#f4a12d'}} ><Icons style={styles.icon14} name='user-following' color="#f4a12d" /> 选择</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                ...
                {/* <View style={styles.rowldv}>
                    <TouchableOpacity onPress={this.xzkehu.bind(this, rowData)}>
                        <View style={styles.rowendv}>
                            <Text style={styles.fonthuangsborer16} >选择</Text>
                        </View>
                    </TouchableOpacity>
                </View> */}
